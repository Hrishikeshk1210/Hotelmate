...
// ** Reactstrap Imports
import {Row, Col, Card, Form, Label, Button, CardBody, CardTitle, CardHeader, InputGroup, InputGroupText } from 'reactstrap'
...
const ValidationThirdPartyComponents = () => {
  ...
  const onSubmit = data => {
    ...
    if (data.firstName !== null && data.lastName !== null && data.email !== null && data.password !== null && data.lastName !== null) {
      ...
      let res = fetch("http://192.168.1.33:14700/user", {
        method: "POST",

...
const SourceGroup = () => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    { headerName: 'Source Group', field: 'sourceGroup', suppressSizeToFit: true },
  ...
  useEffect(() => {
    fetch('http://192.168.1.33:14700/getSourceGroup?hotelID=1')
    .then(result => result.json())
  ...
  const onSubmit = data => {
    ...
    if ( 
      ...
      console.log("hi")
      let res = fetch("http://192.168.1.33:14700/addSourceGroup", {
        method: "POST",
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      required
                        {...field}
                        className={classnames('form-control', {
                          'is-invalid': data !== null && (data.sourceGroup === null || !data.sourceGroup.length)
                        })}
                      />
                    )}
                  />

...
// ** Reactstrap Imports
import { Card, Form, Label, Button, CardBody, CardTitle, CardHeader, InputGroup,Col, Row,InputGroupText } from 'reactstrap'
...
const SubGroup = () => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    {headerName: 'SubGroup',field: 'subGroup',suppressSizeToFit: true,cellStyle: {'text-align': 'center','background-color': '#F1E39B'}, maxWidth: 140},
    ...
    { headerName: 'GroupID', field: 'groupCode',suppressSizeToFit: true,cellStyle: {'text-align': 'center','background-color': '#F1E39B'}, maxWidth: 140 },
    { headerName: 'Active Status', field: 'isActive' ,suppressSizeToFit: true,cellStyle: {'text-align': 'center','background-color': 'pink'}, maxWidth: 140},
      ...
      toast(
        <div className='d-flex'>
          ...
          <div className='d-flex flex-column'>
           ...
           <h4>Sub Group Submitted Successfull</h4>
          </div>
        </div>
      )
    }
  ...
  return (
    ...
    <Accordion open={open} toggle={toggle}>
      <AccordionItem>
        <AccordionHeader targetId='1'><h4><b>Add Sub Group </b> </h4></AccordionHeader>

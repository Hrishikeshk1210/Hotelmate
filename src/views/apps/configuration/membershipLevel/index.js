...
const MembershipLevel = () => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    {headerName: 'Membership Level',field: 'membershipLevel',suppressSizeToFit: true},
  ...
  useEffect(() => {
    fetch('http://192.168.1.33:14700/getMembershipLevel?hotelID=1')
  ...
  const onSubmit = data => {
    setData(data)
    if (data.membershipLevel!== null && data.description !== null ) {
        console.log(data)
        ...
        let res = fetch("http://192.168.1.33:14700/addmembershiplevel", {
          method: "POST",
      ...
      toast(
        <div className='d-flex'>
          ...
          <div className='d-flex flex-column'>
            ...
            <h4>Membership Level Added Successfull</h4>
          </div>
        </div>
      )
    }
  ...
  return (
    ...
    <Accordion open={open} toggle={toggle}>
      <AccordionItem>
        <AccordionHeader targetId='1'><h4><b>Add Membership Level </b> </h4></AccordionHeader>
        <AccordionBody accordionId='1'>
        <Card>
      <CardHeader>
        <CardTitle tag='h4'>MembershipLevel</CardTitle>
      </CardHeader>
      <CardBody>
                ...
                render={({ field }) => (
                  ...
                  placeholder='Membership Level'
                    ...
                    className={classnames('form-control', {
                      'is-invalid': data !== null && (data.membershipLevel=== null || !data.membershipLevel.length)
                    })}

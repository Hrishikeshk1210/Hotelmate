...
const Specials = () => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    {headerName: 'Is Active',field: 'isActive',cellStyle: {'text-align': 'center','background-color': '#F1E39B'}, maxWidth: 160 },
  ...
  const onSubmit = data => {
    ...
    if (data.preference.length && data.description.length) {
        ...
        let createspecial = JSON.stringify({
          ...
          "specialGroupID" : data.specialGroupID,
  ...
  return (
    ...
    <Accordion open={open} toggle={toggle}>
      <AccordionItem>
        <AccordionHeader targetId='1'><h4><b>Add Specials </b> </h4></AccordionHeader>

...
let roomTypeID = [
  fetch('http://192.168.1.33:14700/getRoomInventoryRoomTypeID?hotelID=1')
...
setRowData(tabledata)
  ...
  const onSubmit = (data) => {
    ...
    if (
      ...
      let res = fetch("http://192.168.1.33:14700/addroominventory", {
        method: "POST",
        ...
        console.log(res);
        if(res['status']==200){
          fetch('http://192.168.1.33:14700/getroominventory?hotelID='+id)
          .then(result => result.json())

...
let roomTypeID = [
  fetch('http://192.168.1.33:14700/getRoomInventorytForecastRoomTypeID?hotelID=1')
...
const RoomInventoryForecast = () => {
  ...
  useEffect(() => {
    fetch('http://192.168.1.33:14700/getroominventoryforecast?hotelID'+id)
    .then(result => result.json())
  ...
  const onSubmit = (data) => {
    ...
    if (
    ...
    )
     {
      ...
      let res = fetch("http://192.168.1.33:14700/addroominventoryforecast", {
        method: "POST",

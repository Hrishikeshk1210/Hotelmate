  ...
  const onSubmit = data => {
    ...
    if (
      ...
      let createmarketGroup = JSON.stringify({        
        ...
        "notes": data.notes,
        "guestType": data.guestType.value,
        "lastVisit": data.lastVisit,
        "isActive": data.isActive.value,
        "isBlackListed": data.isBlackListed.value,
              ...
              <Col md='6' sm='12'>
                <div className='mb-1'>
                  ...
                  <Controller
                    ...
                    id='firstName'
                    name='firstName'
                    render={({ field }) => <Input placeholder='First Name' invalid={errors.firstName && true} {...field} />}
                  />
                </div>
              </Col>
              <Col md='6' sm='12'>
                <div className='mb-1'>
                  ...
                  <Controller
                    ...
                    id='lastName'
                    name='lastName'
                    render={({ field }) => <Input placeholder='Last Name' invalid={errors.lastName && true} {...field} />}
                  />
                </div>
              </Col>
              <Col md='6' sm='12'>
                <div className='mb-1'>
                  ...
                  <Controller
                    ...
                    id='salutation'
                    name='salutation'
                    render={({ field }) => <Input placeholder='Last Name' invalid={errors.salutation && true} {...field} />}
                  />
                </div>
              </Col>
              ...
              <Col md='6' sm='12'>
                <div className='mb-1'>
                  ...
                  <Controller
                    ...
                    id='nationality'
                    name='nationality'
                    render={({ field }) => <Input placeholder='Last Name' invalid={errors.nationality && true} {...field} />}
                  />
                </div>
              </Col>
              <Col md='6' sm='12'>
              ...
              <Col md='6' sm='12' className='mb-1'>
                <div className="mb-1">
                  ...
                  <InputGroup className='input-group-merge'>
                    ...
                    /><Button color='primary' onClick={() => setCenteredModal(!centeredModal)}>B</Button>
                  </InputGroup>
                </div>
              </Col>
